...
const Page = () => {
  ...
  useEffect(() => {
    fetch(`https://final-project-server-sage.vercel.app/profile?email=${user?.email}`, {
      headers: {
        ...
        <div class="">
          <div class="px-7 mb-8">
            <p class="text-gray-400 mt-2 flex dark:text-gray-400">
              <p className="font-bold mx-1">Full Name:</p>{" "}
            ...
            <p class="text-gray-400 mt-2 flex dark:text-gray-400">
              <p className="font-bold mx-1">Email:</p> <p>{user?.email}</p>
            </p>
